  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="/fresh-fruits-and-vegetables-farm-landscape-pakista.jpg"
          alt="Fresh produce landscape"
      ...
      <div className="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <button
            ...
            className="bg-white text-primary hover:bg-white/90 font-medium px-8 py-3 rounded-md transition-colors flex items-center"
          >
            Get Started
          ...
          <button
            ...
            className="border border-white text-white hover:bg-white hover:text-primary font-medium px-8 py-3 rounded-md bg-transparent transition-colors"
          >
            Learn More
          </button>
        </div>
